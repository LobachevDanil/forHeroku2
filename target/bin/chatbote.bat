...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="chatbote" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" chatBote.TelegramProgram %CMD_LINE_ARGS%
